...
#define TUYA_OPENSDK_UUID    "uuid3fe6b5f93d3b9424"            // Please change the correct uuid
#define TUYA_OPENSDK_AUTHKEY "i9lMwRWfm8lfdkcoZnYh7OnAZfn2liLw" // Please change the correct authkey
