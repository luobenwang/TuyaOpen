...
#define TUYA_OPENSDK_UUID    "uuida5d79e564bee67fe"             // Please change the correct uuid
#define TUYA_OPENSDK_AUTHKEY "VfVCZFdjFByHouNSSLAeCKgjVO78uznw" // Please change the correct authkey
