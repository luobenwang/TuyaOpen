...
/** Slide-in duration (ms); larger = slower entrance */
#define UI_AI_CHAT_ENTR_MS    450
/** One full horizontal marquee cycle (ms); plain value = fixed duration (LVGL9 label scroll) */
#define UI_AI_CHAT_SCROLL_MS  9000
...
int __ui_ai_chat_init(void)
{
    ...
    lv_obj_set_style_anim_duration(s_label, UI_AI_CHAT_SCROLL_MS, 0);
