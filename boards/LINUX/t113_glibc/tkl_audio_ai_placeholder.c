 ...
 *        spotting) audio AI hooks for the Allwinner T113 (glibc) board.
 * @version 1.0
 * @date 2026-06-01
 ...
 *       not available for the 32-bit armv7 T113, so this board provides weak,
 ...
 *
 *       To enable real on-device wake word / VAD on a T113, drop armv7 builds of
 *       libaudio_subsys / libMNN / libopus into
 *       platform/LINUX/tuyaos_adapter/src/tkl_audio/libs/t113_glibc/ and enable
