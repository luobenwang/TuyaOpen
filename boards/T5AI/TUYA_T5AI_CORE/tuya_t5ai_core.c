 ...
 ************************macro define************************
 ***********************************************************/
 #define BOARD_SPEAKER_EN_PIN TUYA_GPIO_NUM_8
 ...
 #define BOARD_LCD_BL_PIN             TUYA_GPIO_NUM_34
 ...
 #define BOARD_LCD_SPI_CS_PIN         TUYA_GPIO_NUM_50
 #define BOARD_LCD_SPI_DC_PIN         TUYA_GPIO_NUM_23
 #define BOARD_LCD_SPI_RST_PIN        TUYA_GPIO_NUM_25
